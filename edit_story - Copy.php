                    ...
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-control">
                            ...
                            <option value="Adventure"
                                ...
                                Adventure</option>
                            <option value="Comedy"
                                <?php echo (isset($story['category']) && $story['category'] == 'Comedy') ? 'selected' : ''; ?>>
                                Comedy</option>
                            <option value="Drama"
                                <?php echo (isset($story['category']) && $story['category'] == 'Drama') ? 'selected' : ''; ?>>
                                Drama</option>
                            <option value="Fantasy"
                                <?php echo (isset($story['category']) && $story['category'] == 'Fantasy') ? 'selected' : ''; ?>>
                                Fantasy</option>
                            <option value="Historical Fiction"
                                <?php echo (isset($story['category']) && $story['category'] == 'Historical Fiction') ? 'selected' : ''; ?>>
                                Historical Fiction</option>
                            <option value="Horror"
                                <?php echo (isset($story['category']) && $story['category'] == 'Horror') ? 'selected' : ''; ?>>
                                Horror</option>
                            <option value="Mystery"
                                <?php echo (isset($story['category']) && $story['category'] == 'Mystery') ? 'selected' : ''; ?>>
                                Mystery</option>
                            <option value="Romance"
                                <?php echo (isset($story['category']) && $story['category'] == 'Romance') ? 'selected' : ''; ?>>
                                Romance</option>
                            <option value="Science Fiction"
                                <?php echo (isset($story['category']) && $story['category'] == 'Science Fiction') ? 'selected' : ''; ?>>
                                Science Fiction</option>
                            <option value="Thriller"
                                <?php echo (isset($story['category']) && $story['category'] == 'Thriller') ? 'selected' : ''; ?>>
                                Thriller</option>
                        </select>
                    </div>
...
//http://localhost/ChristianProject/images/1679056580_helio_ci_1673108943.jpg
// source: `http://localhost/ChristianProject/${image}`,
            return {
